...
public class Example1 implements GLEventListener
{
	...
	public Example1( List< RaiLevel > raiLevels, final AffineTransform3D sourceTransform )
	{
...
//			System.out.println( "gj = " + Arrays.toString( gj ) + ", level = " + level );
	...
	public void display( final GLAutoDrawable drawable )
	{
		...
		computeRequiredBlocks( model, view, projection );
...
//		screenPlane.draw( gl );
	...
	private void computeRequiredBlocks( final Matrix4f model, final Matrix4f view, final Matrix4f projection )
	{
		...
		for ( RaiLevel raiLevel : raiLevels )
		{
			...
			final RequiredBlocks requiredBlocks = getRequiredBlocksFrustum( pvm, blockSize, sourceSize, raiLevel.r );
			System.out.println( raiLevel.level + ": requiredBlocks = " + requiredBlocks );
		}
		System.out.println( "===========================================");
		System.out.println();
	}
	...
	public static void main( final String[] args ) throws SpimDataException
	{
		...
		Example1 glPainter = new Example1( raiLevels, sourceTransform );
