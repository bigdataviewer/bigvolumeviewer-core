...
public class Example5 implements GLEventListener
{
	...
	public void init( final GLAutoDrawable drawable )
	{
		...
		ShaderCode vs = ShaderCode.create( gl3, GL2.GL_VERTEX_SHADER, Example5.class, "", null, "ex5", true );
		ShaderCode fs = ShaderCode.create( gl3, GL2.GL_FRAGMENT_SHADER, Example5.class, "", null, "ex5", true );
	...
	{
		new SimpleFrame( "Example5", 640, 480, new Example5() );
	}
}
