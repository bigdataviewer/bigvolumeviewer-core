...
public class Example6 implements GLEventListener
{
	...
	public void init( final GLAutoDrawable drawable )
	{
		...
		try
		{
			data = Images.loadBytesRGB( Example6.class.getResourceAsStream( "container.jpg" ) );
//			data = Images.loadBytesRGBA( Example6.class.getResourceAsStream( "awesomeface.png" ) );
		}
		catch ( IOException e )
		{
			e.printStackTrace();
	...
	{
		new SimpleFrame( "Example6", 640, 480, new Example6() );
	}
}
