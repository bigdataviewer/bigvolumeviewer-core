 ...
 * vertex position (see how even the vertex position values are interpolated across the triangle).
...
public class Task3 implements GLEventListener
{
	...
	{
		new SimpleFrame( "Task3", 640, 480, new Task3() );
	}
}
