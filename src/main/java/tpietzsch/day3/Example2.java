...
/**
 * Textured rectangle with <em>projection * view * model</em> in java.
 * (Only 1 matrix multiplication in shader)
 */
public class Example2 implements GLEventListener
{
	...
	public void init( final GLAutoDrawable drawable )
	{
		...
		try
		{
			data = Images.loadBytesRGB( Example2.class.getResourceAsStream( "container.jpg" ) );
		}
		...
		try
		{
			data = Images.loadBytesRGBA( Example2.class.getResourceAsStream( "awesomeface.png" ), true );
		}
		catch ( final IOException e )
		{
			e.printStackTrace();
