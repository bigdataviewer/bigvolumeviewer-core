...
public class Example3 implements GLEventListener
{
	...
	public void init( final GLAutoDrawable drawable )
	{
		...
		try
		{
			data = Images.loadBytesRGB( Example3.class.getResourceAsStream( "container.jpg" ) );
		}
		...
		try
		{
			data = Images.loadBytesRGBA( Example3.class.getResourceAsStream( "awesomeface.png" ), true );
		}
		catch ( final IOException e )
		{
			e.printStackTrace();
