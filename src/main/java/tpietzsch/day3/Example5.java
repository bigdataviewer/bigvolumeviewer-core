...
public class Example5 implements GLEventListener
{
	...
	public void init( final GLAutoDrawable drawable )
	{
		...
		try
		{
			data = Images.loadBytesRGB( Example5.class.getResourceAsStream( "container.jpg" ) );
		}
		...
		try
		{
			data = Images.loadBytesRGBA( Example5.class.getResourceAsStream( "awesomeface.png" ), true );
		}
		catch ( final IOException e )
		{
			e.printStackTrace();
	...
	{
		new SimpleFrame( "Example3", 640, 480, new Example5() );
	}
}
