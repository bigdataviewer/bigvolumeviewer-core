...
public class OffScreenFrameBuffer
{
	...
	private void initFrameBuffer( GL3 gl )
	{
		...
		gl.glTexImage2D( GL_TEXTURE_2D, 0, internalFormat, fbWidth, fbHeight, 0, GL_RGB, GL_UNSIGNED_BYTE, null );
	...
	private void initQuad( GL3 gl )
	{
		...
		progQuad = new Shader( gl, "ex1quad", "ex1quad", OffScreenFrameBuffer.class );
	}
