...
public class Example0 implements GLEventListener
{
	...
	public Example0( final RandomAccessibleInterval< UnsignedShortType > rai, final AffineTransform3D sourceTransform )
	{
		this.rai = rai;
	...
	public void init( final GLAutoDrawable drawable )
	{
		...
		prog = new Shader( gl, "ex1", "ex1", tpietzsch.day6.Example3.class );
		progvol = new Shader( gl, "ex1", "ex3slice", tpietzsch.day6.Example3.class  );
	...
	private void loadTexture( final GL3 gl )
	{
		...
		gl.glTexSubImage3D( GL_TEXTURE_3D, 0, 0, 0, 0, w, h, d, GL_RED, GL_UNSIGNED_SHORT, data );
...
//		gl.glTexImage3DMultisample();
	...
	public static void main( final String[] args ) throws SpimDataException
	{
		...
		Example0 glPainter = new Example0( rai, sourceTransform );
