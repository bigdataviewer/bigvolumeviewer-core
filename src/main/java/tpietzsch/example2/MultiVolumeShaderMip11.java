...
public class MultiVolumeShaderMip11
{
	...
	public MultiVolumeShaderMip11( final int numBigVolumes, final int numSmallVolumes, final boolean useDepthTexture, final double degrade )
	{
